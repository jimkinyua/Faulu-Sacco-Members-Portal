...
class MemberEditingAttachments extends Model
{
    ...
    public function SaveDocumentToNav($model, $MfilesUrl){
        $service = Yii::$app->params['ServiceName']['MemberEditingAttachments'];
