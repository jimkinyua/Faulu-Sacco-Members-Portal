 ...
 */
class NavisionMemberApplication extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return  Yii::$app->params['DbCompanyName'] . 'Member Application '; //'PortalMembers ';
    ...
    public static function findApplicant($ID)
    {
        return static::findOne([
            // 'Processed' => 0,
            'ID No_' => trim($ID),
    ...
    public function getMemberCategory()
    {
        ...
        $employee = \Yii::$app->navhelper->findOneRecord($service, 'No', $this->{'No_'});
    ...
    {
        $service = Yii::$app->params['ServiceName']['MemberApplicationSingle'];
        $Applicant = \Yii::$app->navhelper->findOneRecord($service, 'No', $this->{'No_'});
        return $Applicant;
    }
