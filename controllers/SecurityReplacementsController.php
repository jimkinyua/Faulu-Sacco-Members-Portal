...
use app\models\SecurityReplacements;
...
class SecurityReplacementsController extends Controller
{
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'only' => [
                    'create', 'create-security','index',
                    'update', 'update-security', 'delete',
                    'get-loan-securities', 
                ],
                'rules' => [
                     [
    ...
    public function actionCreate($DocNum, $Existing, $LoanNo){

        $model = new SecurityReplacements();
        $service = Yii::$app->params['ServiceName']['SecurityReplacements'];
        $model->Document_No = $DocNum;
        if(Yii::$app->request->post() && $this->loadpost(Yii::$app->request->post()['SecurityReplacements'],$model)){
            $model->Document_No = $DocNum;
            $model->Code = $model->Replace_With;
            $model->Security_Code = urldecode($Existing);
            $model->Loan_No = urldecode($LoanNo);
            //      echo '<pre>';
            // print_r($model);
            // exit;
    ...
    public function actionCreateSecurity($DocNum, $Existing){
        ...
        if(Yii::$app->request->post() && $this->loadpost(Yii::$app->request->post()['SecurityReplacements'],$model)){
            ...
            $model->Document_No = $DocNum;
            $model->Type = 'Security';
            $replaceWith = Yii::$app->request->post()['SecurityReplacements']['Replace_With'];
            // echo '<pre>';
            // print_r($model);
            // exit;
