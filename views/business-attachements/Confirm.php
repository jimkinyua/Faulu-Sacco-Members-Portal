                        ...
                        <p>
                            <div class="CustomList">
                                <ol style="padding-left: revert;" >
                                    ...
                                    <li>
                                        <p> iii)	A member will be required to maintain a monthly deposit contribution depending on loan repayment period and amount contribution subject to the current requirements based on loan applied for as shown below:   </p>
