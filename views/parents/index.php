    ...
    <?php if($Applicant->Portal_Status == 'New'): ?>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <?= \yii\helpers\Html::a('Add Parent',['create','Key'=> $Applicant->Key],['class' => 'create btn btn-info btn-md mr-2 ']) ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    $(function(){
        ...
        // $.fn.dataTable.ext.errMode = 'throw';
          ...
          $('#leaves').DataTable({
            ...
            //serverSide: true,  
            ajax: absolute+'parents/getparents?AppNo='+Docnum,
            paging: true,
            responsive:true,
            columns: [
                { title: '#', data: 'index'},
                ...
                { title: 'Other Names' ,data: 'Other_Names'},
                { title: 'Phone No' ,data: 'Mobile_Phone'}, 
           ...
           language: {
                "zeroRecords": "No Parents to Show.."
            },
