    ...
    <?php if($Applicant->Portal_Status == 'New'): ?>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <?= \yii\helpers\Html::a('Add Signatory',['create','Key'=> $Applicant->Key],['class' => 'create btn btn-info btn-md mr-2 ']) ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    $(function(){
        ...
        // $.fn.dataTable.ext.errMode = 'throw';
          ...
          $('#leaves').DataTable({
            ...
            //serverSide: true,  
            ajax: absolute+'signatories/getsignatories?AppNo='+Docnum,
            paging: true,
            responsive:true,
            columns: [
                { title: '#', data: 'index'},
                ...
                { title: 'Must Sign' ,data: 'Must_Sign'},   
                { title: 'Remove' ,data: 'Remove'},             
                { title: 'Edit' ,data: 'Update_Action'},
                
            ] ,                              
           language: {
                "zeroRecords": "No Sigantories to Show.."
            },
