                ...
                <table class="table table-hover" id="leaves">
                    <thead>
                        <tr>
                            ...
                            <th class="border-0">Amount Guaranteed</th>	
                    ...
                    <?php if(!is_object($GuarantorshipRequests)): ?>
                                    ...
                                    <?php foreach($GuarantorshipRequests as $GuarantorshipRequest): ?> 
                                        <tr>
                                            ...
                                            <td><span class="font-weight-normal"><?= @number_format($GuarantorshipRequest->Amount_Accepted) ?></span></td>
                                            <?php
                    ...
                    <?php if(!is_object($GuarantorSubstituitionRequests)): ?>
                        <?php foreach($GuarantorSubstituitionRequests as $GuarantorSubstituitionRequest): ?> 
                            <tr>
                                <td><span class="font-weight-normal"><?= @$GuarantorSubstituitionRequest->Loan_No ?></span></td>
                                <td><span class="font-weight-normal"><?= @number_format($GuarantorSubstituitionRequest->AppliedAmount) ?></span></td>
