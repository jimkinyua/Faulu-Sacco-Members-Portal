...
?>
                    ...
                    <h3 class="card-title"> Scheme Closure Form</h3>
                        ...
                        <div class="row">
                            ...
                            <div class=" row col-md-12">
                                <div class="col-md-12">
                                    ...
                                    <?= $form->field($model, 'Closing_Reason')->textInput() ?>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <?= Html::submitButton('Submit Account Closure Request', ['class' => 'btn btn-success']) ?>
                                </div>
                            </div>
