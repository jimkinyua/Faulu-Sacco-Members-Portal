...
<h3 class="card-title"> Exit Request Form </h3>
...
<div class="card-body">
    ...
    <div class="row">
        <div class=" row col-md-12">
            ...
            <div class="col-md-6">
                <?= $form->field($model, 'Withdrawal_Type')->dropDownList([
                    'General' => 'General',
                    'Retiree' => 'Retiree',
                    // 'Desceased'=>'Desceased'
                ], ['prompt' => 'Select Withdrawal Reason'])
                ?>
                <?= $form->field($model, 'Withdrawal_Reason')->textarea(['rows' => 4, 'cols' => 6]) ?>
            ...
            <div class="col-md-6">
                ...
                <?= $form->field($model, 'Instant')->dropDownList([
                    '0' => 'No',
                    '1' => 'Yes',
    ...
    <div class="row">
        <div class="form-group">
            <?= Html::submitButton('Submit Exit Request', ['class' => 'btn btn-success']) ?>
        </div>
    </div>
