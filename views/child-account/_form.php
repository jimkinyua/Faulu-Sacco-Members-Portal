...
?>
    ...
    <!--END THE STEPS THING--->
                    ...
                    <div class="card-body">
                            ...
                            <div class=" row col-md-12">
                                <?php if($model->Portal_Status=='Application'): ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <?= $form->field($model, 'Total_Principle_Repayment')->textInput(['type' => 'number', 'readonly'=>true]) ?>
                                    </div>

                                    <div class="col-md-3">
                                        <?= $form->field($model, 'Applied_Amount')->textInput(['type' => 'number']) ?>
                                        <?= $form->field($model, 'Total_Interest_Repayment')->textInput(['type' => 'number', 'readonly'=>true]) ?>
                                    </div>

                                    <div class="col-md-3">
                                        <?= $form->field($model, 'Repayment_Period_M')->textInput(['type' => 'number']) ?>
                                        <?= $form->field($model, 'Total_Loan_Repayment')->textInput(['type' => 'number', 'readonly'=>true]) ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="col-md-3">
                                        <?= $form->field($model, 'Applied_Amount')->textInput(['type' => 'number', 'readonly'=>true]) ?>
                                        <?= $form->field($model, 'Total_Interest_Repayment')->textInput(['type' => 'number', 'readonly'=>true]) ?>
                                    </div>

                                    <div class="col-md-3">
                                        <?= $form->field($model, 'Repayment_Period_M')->textInput(['type' => 'number', 'readonly'=>true]) ?>
                                        <?= $form->field($model, 'Total_Loan_Repayment')->textInput(['type' => 'number', 'readonly'=>true]) ?>
                        ...
                        <h3> Economic Sector Funding Details</h3>
                        <hr>
                        <div class="row">
                            <div class=" row col-md-12">
                                <?php if($model->Portal_Status=='Application'): ?>
