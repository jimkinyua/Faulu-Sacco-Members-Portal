...
?>
                    ...
                    <h3 class="card-title">Security Details</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class=" row col-md-12">
                                ...
                                <div class="col-md-12">
                                    <?= $form->field($model, 'Replace_With')->dropDownList(Arrayhelper::map($LoanSecurities, 'Code', 'Name'),['prompt' => 'Select Security Type']) ?>
                                    <?= $form->field($model, 'Security_Details')->textInput() ?>
