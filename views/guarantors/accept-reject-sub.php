...
// $loanDetails = Yii::$app->recruitment->getLoanDetails(Yii::$app->recruitment->getLoanNoFromGuarantorShipRequest($model->Document_No));
// $LoanDetails = 0;
?>
        ...
        <div class=" row col-md-12">
            ...
            <div class="col-md-12">
                <?php if ($model->Accepted === true) : ?>
                    ...
                    <?= $form->field($model, 'Amount')->textInput(['readonly' => true, 'maxlength' => true]) ?>


                    <?= $form->field($model, 'Amount')->textInput(['type' => 'number', 'maxlength' => true]) ?>
                <?php else : ?>
