...
<div class="site-login">
    ...
    <div class="form-group">
        <div class="d-block d-sm-flex justify-content-between align-items-center mt-1">
            <div>
                <a href="<?= Url::to('site/oauth-authorize',  $schema = true) ?>" class='btn btn-success text-right' ,> Go Back </a>
            </div>


            <div>
                <?= Html::submitButton('Login', ['class' => 'btn btn-default text-right', 'name' => 'login-button',]) ?>
            </div>
